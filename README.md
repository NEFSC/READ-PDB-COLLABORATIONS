...
| ROracle_keypass_example | Example code to use package keypass to securely store your Oracle connection info |
...
| survey_evaluation | Package to evaluate survey sampling, stratum tows, stratum means, stratum contributions to aggregate index, etc.|
| Ismooth_workflow | New functions and a workflow for Ismooth (aka PlanBsmooth) using monkfish stocks as an example |
